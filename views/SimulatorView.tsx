                     ...
                     <div className="mt-4 border-t border-gray-200 dark:border-gray-700 pt-4 overflow-y-auto max-h-96">
                        ...
                        {isAnalysisVisible && (
                            <div className="animate-fade-in">
                                ...
                                {isLoading ? (<div className="text-sm text-gray-500 dark:text-gray-400 flex items-center p-2"><svg className="animate-spin mr-3 h-5 w-5 text-indigo-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>{t('simulator.analyzingLogic')}</div>) : (
                                    <>
                                        {issues.length > 0 ? (
                                        ...
                                        ) : (!error && isAnalyzed && <p className="text-sm text-green-600 dark:text-green-400 p-2">{t('simulator.noIssues')}</p>)}
                                        ...
                                        {isSuggesting && (<div className="text-sm text-gray-500 dark:text-gray-400 flex items-center p-2 mt-4"><svg className="animate-spin mr-3 h-5 w-5 text-indigo-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path></svg>{t('tools.logicValidator.suggesting')}</div>)}
                                        {suggestedCode && (
