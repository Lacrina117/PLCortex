...
export const LoadingSpinner: React.FC = () => {
  ...
  return (
    <div className="text-center my-10 p-6 bg-gray-100/50 dark:bg-gray-800/50 rounded-lg">
      ...
      <p className="mt-4 text-lg font-semibold text-gray-700 dark:text-gray-300">{t('spinnerLoading')}</p>
      <p className="text-sm text-gray-500 dark:text-gray-400">{t('spinnerWait')}</p>
    </div>
  );
};