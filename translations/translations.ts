// FIX: Implemented the translations file with English and Spanish text for all UI elements, including complex data structures for reference tables. This resolves the 'not a module' error.
export const translations = {
    en: {
        ...
        // Calculator
        calculator: {
            title: 'Panel Calculators',
            description: 'Tools for common electrical panel design calculations.',
            thermal: {
        ...
        simulator: {
            ...
            description: 'Write, validate, and simulate simple PLC logic in a text-based format. You can also paste ASCII art to translate it.',
            editorTitle: 'Logic Editor',
            codePlaceholder: 'Enter logic here, e.g., XIC(Start) XIO(Stop) OTE(Motor)\nOr paste ASCII art from other tools.',
            simulationTitle: 'Simulation',
            controls: 'Controls',
            analyzeAndRunButton: 'Analyze & Run',
            analyzingLogic: 'Analyzing...',
            stopSimulationButton: 'Stop Simulation',
            ...
            outputs: 'Outputs',
            noOutputs: 'No outputs detected.',
            analysisResults: 'Analysis Results',
            noIssues: '✅ No logical errors found. Ready to run.',
            suggestSolutionButton: 'Suggest a Fix',
            suggestingSolutionButton: 'Generating Fix...',
            suggestedCodeTitle: 'Suggested Code',
            implementSolutionButton: 'Implement Fix',
        }
    },
    es: {
        // Header & Descriptions
        ...
        // Calculator
        calculator: {
            title: 'Calculadoras de Panel',
            description: 'Herramientas para cálculos comunes en el diseño de gabinetes eléctricos.',
            thermal: {
                ...
                calculateButton: 'Calcular Carga Térmica',
        ...
        // Simulator
        simulator: {
            title: 'Simulador de Lógica PLC',
            description: 'Escribe, valida y simula lógica de PLC simple en un formato basado en texto. También puedes pegar arte ASCII para traducirlo.',
            editorTitle: 'Editor de Lógica',
            codePlaceholder: 'Ingresa la lógica aquí, ej., XIC(Start) XIO(Stop) OTE(Motor)\nO pega arte ASCII de otras herramientas.',
            simulationTitle: 'Simulación',
            controls: 'Controles',
            analyzeAndRunButton: 'Analizar y Ejecutar',
            analyzingLogic: 'Analizando...',
            stopSimulationButton: 'Detener Simulación',
            cpuStatus: 'Estado del CPU:',
            run: 'RUN',
            stop: 'STOP',
            fault: 'FALLA',
            inputs: 'Entradas',
            noInputs: 'No se detectaron entradas.',
            outputs: 'Salidas',
            noOutputs: 'No se detectaron salidas.',
            analysisResults: 'Resultados del Análisis',
            noIssues: '✅ No se encontraron errores lógicos. Listo para ejecutar.',
            suggestSolutionButton: 'Sugerir Corrección',
            suggestingSolutionButton: 'Generando Corrección...',
            suggestedCodeTitle: 'Código Sugerido',
            implementSolutionButton: 'Implementar Corrección',
        }
    },
};