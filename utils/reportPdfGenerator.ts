 ...
 * It parses the Markdown-like text from Gemini and renders it
...
export const generateAuditGradePdf = (reportContent: string, metadata: ReportMetadata) => {
    ...
    const drawFooter = () => {
        ...
        doc.text(`Page ${pageCount} | Generated by PLCortex AI Engineering Assistant`, margin, pageHeight - 20);
    ...
    lines.forEach((line) => {
        ...
        // Detect Headers (Markdown style # or just uppercase heavy lines from AI)
